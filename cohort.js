const students = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "become more competitive in job market",
      "travel",
      "unique restaurants",
    ],
  ...
  },
  {
    ...
    os: "mac",
    keywords: [
      "expand opportunities at current company",
      "pivot into tech",
      "coding skills",
      "running",
      "hiking",
  ...
  },
  {
    ...
    keywords: [
      "learn front end",
      "supplement existing back end knowledge",
      "fictional author",
  ...
  },
  {
    ...
    os: "windows",
    keywords: [
      "move into technical department in programming",
      "yoga",
      "meditation",
      "skiing",
      "hiking",
  ...
  },
  {
    ...
    os: "mac",
    keywords: [
      "transitioning from QA Engineer to API Developer",
      "acquire foundational skills for new role",
      "plants",
      "gardening",
      "hanging out with son & wife",
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      "baseball",
      "travel",
      "favorite destination is Grand Cayman",
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      "video games",
      "making YouTube videos on pop music",
      "sports",
    ],
  ...
  },
  {
    ...
    keywords: [
      "new career",
      "application, web, and game development",
      "music",
      "gaming",
      "cooking",
    ],
  ...
  },
  {
    ...
    keywords: [
      "career change",
      "currently in service industry",
      "BA in Linguistics",
      "loves design",
      "mystery novels",
      "computer games (fave: Nancy Drew game)",
  ...
  },
  {
    ...
    os: "mac",
    keywords: [
      "career in high demand industry",
      "help mom retire",
      "wants to prove the doubters wrong",
      "soccer",
      "workout",
      "hikes with German Shepard",
    ],
    linkedIn: "",
  },
  {
  ...
  },
  {
    ...
    keywords: [
      ...
      "curious about web technologies",
      "bikes",
      "cooking",
    ],
  ...
  },
  {
    ...
    os: "windows",
    keywords: [
      "Began CS degree at UC Merced Pre-COVID",
      "Boot camp to finish gaining skills",
      "better job",
      "travel",
      "soccer",
      "cars",
  ...
  },
  {
    ...
    keywords: [
      ...
      "wants to help him with software development",
      "being in tech is pretty cool :)",
      "sleeping",
      "traveling",
      "stretching",
    ],
    linkedIn: "https://linkedin.com/in/ha-nguyen-0518a1151",
  },
  {
    name: "Nirali Parmar",
    location: "Dublin, CA",
    ...
    os: "mac",
    keywords: [
      "currently a software QA engineering manager",
      "wants to pursue dev roles or managerial dev roles",
      "Adventures",
      "Bollywood dancing",
    ],
    linkedIn: "",
  },
  {
    ...
    isInTech: true,
    os: "mac",
    keywords: ["expand knowledge in the subject", "read", "travel", "music"],
    linkedIn: "",
  },
  {
    name: "Cassandra Kise (Cassie)",
    location: "West Oakland, CA",
    isInTech: false,
    os: "mac",
    keywords: [
      "currently director of innovation and design & chair of Eng, Entrepreneurship, and CS at The Athenian School",
      "teacher",
      "wants to help plan school curriculum",
      "prep for grad school",
      "Australian Shepherd (Roux)",
      "read",
      "German",
      "paddleboard",
      "kayak",
    ],
    linkedIn: "https://www.linkedin.com/in/cassandrakise/",
  },
  {
    name: "Madeleine Conanan",
    ...
    linkedIn: "https://www.linkedin.com/in/mconanan",
  },
  {
    name: "Hunter Brennan",
    ...
    linkedIn: "https://www.linkedin.com/in/hunter-brennan-523000241/",
  },
  {
    name: "Amberlie Arave",
    location: "Chico, CA",
    ...
    os: "windows",
    keywords: [
      "providing for my family in a field that will always have opportunity",
      "Dungeons & Dragons (player & DM)",
      "make terrain pieces for tabletop games",
      "video games",
      "author",
    ],
    linkedIn: "https://www.linkedin.com/in/amberlie-arave-580b591b4/",
  },
  {
    name: "Blessed Adodo (CollzBaba)",
    location: "Oakland, CA",
    isInTech: false,
    os: "mac",
    keywords: [
      "aspires to be web designer & successful in tech",
      "fashion designing",
      "modeling",
      "walks by the beach",
    ],
    linkedIn: "https://www.linkedin.com/in/blessed-adodo-23b895156",
  },
  {
    name: "Wenfeng Huang (William)",
    location: "Oakland, CA",
    isInTech: false,
    os: "windows",
    keywords: ["higher pay", "music", "sleep"],
    linkedIn: "https://www.linkedin.com/in/wenfeng-huang-14369323a/",
  },
];
...
const instructors = [
  {
    ...
    keywords: [
      "former radio dj",
      "sr front end dev @ AWS",
      "mountain biking",
      "road cycling",
      "bassist for 80's/90's pop/rock cover band \"Retroflection\"",
    ],
