...
// var setTitle= document.querySelector('h4');
// console.log('setTitles',setTitles);
...
for(var i = 0; i < setTitles.length; i++){
    setTitles[i].setAttribute("style", "color:blue; font-weight:bold; font-size:200px; padding-left:10px; margin:0 ");
}
